...
let token buf =
  begin
    ...
    | ')' -> RPAR
    (* YOUR TOKENS HERE... *)
    | _ -> illegal buf (Base.Option.value_exn (next buf))
  (* Ignore unused rec flag warning
   * Possibly due to buggy code generated by sedlex PPX
   * will not be issued in sedlex > 2.0
   * see github.com/ocaml-community/sedlex/pull/73
   *)
  end [@ocaml.warning "-39"]
